...
const testSeed = `map[string]any{"entity": map[string]any{"current": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "historical": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "weather_forecast": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
