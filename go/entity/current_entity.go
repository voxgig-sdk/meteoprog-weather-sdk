...
import (
	...
	vs "github.com/voxgig-sdk/meteoprog-weather-sdk/go/utility/struct"
)

type CurrentEntity struct {
	name    string
	client  *core.MeteoprogWeatherSDK
...
func NewCurrentEntity(client *core.MeteoprogWeatherSDK, entopts map[string]any) *CurrentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CurrentEntity) GetName() string { return e.name }
...
func (e *CurrentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CurrentEntity) Deleted() bool {
	return e.deleted
}


func (e *CurrentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCurrentEntity(e.client, opts)
}

func (e *CurrentEntity) Data(args ...any) any {
...
func (e *CurrentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Current; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CurrentEntity) DataTyped(data ...Current) Current {
	if len(data) > 0 {
		return typedFrom[Current](e.Data(asMap(data[0])))
	}
	return typedFrom[Current](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Current (all fields
// optional at the wire level).
func (e *CurrentEntity) MatchTyped(match ...Current) Current {
	if len(match) > 0 {
		return typedFrom[Current](e.Match(asMap(match[0])))
	}
	return typedFrom[Current](e.Match())
}
...
func (e *CurrentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CurrentEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CurrentLoadMatch and returns an Current. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CurrentEntity) LoadTyped(reqmatch CurrentLoadMatch, ctrl map[string]any) (Current, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Current{}, err
	}
	return typedFrom[Current](res), nil
}



func (e *CurrentEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CurrentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CurrentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CurrentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CurrentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
