# MeteoprogWeather Golang SDK Reference

Complete API reference for the MeteoprogWeather Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *MeteoprogWeatherSDK`
...
#### `Current(data map[string]any) MeteoprogWeatherEntity`

Create a new `Current` entity instance. Pass `nil` for no initial data.

#### `Historical(data map[string]any) MeteoprogWeatherEntity`

Create a new `Historical` entity instance. Pass `nil` for no initial data.

#### `WeatherForecast(data map[string]any) MeteoprogWeatherEntity`
