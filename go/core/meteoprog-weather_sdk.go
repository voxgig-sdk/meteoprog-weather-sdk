...
type MeteoprogWeatherSDK struct {
	Mode     string
...
func (sdk *MeteoprogWeatherSDK) OptionsMap() map[string]any {
...
func (sdk *MeteoprogWeatherSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *MeteoprogWeatherSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *MeteoprogWeatherSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MeteoprogWeatherSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *MeteoprogWeatherSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *MeteoprogWeatherSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("MeteoprogWeatherSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *MeteoprogWeatherSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MeteoprogWeatherSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("MeteoprogWeatherSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *MeteoprogWeatherSDK {
	...
	sdk := NewMeteoprogWeatherSDK(sdkopts)
	sdk.Mode = "test"
