...
// instead of `sdk.NewMeteoprogWeatherSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *MeteoprogWeatherSDK  { return NewMeteoprogWeatherSDK(nil) }
func Test() *MeteoprogWeatherSDK { return TestSDK(nil, nil) }
