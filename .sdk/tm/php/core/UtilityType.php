...
// MeteoprogWeather SDK utility type

class MeteoprogWeatherUtility
{
    ...
    public static function copy(MeteoprogWeatherUtility $src): MeteoprogWeatherUtility
    {
        $u = new MeteoprogWeatherUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
