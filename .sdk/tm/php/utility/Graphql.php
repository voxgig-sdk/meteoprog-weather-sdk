...
// MeteoprogWeather SDK utility: graphql
//
...
class MeteoprogWeatherGraphql
{
    ...
    // equivalent.
    public static function body(MeteoprogWeatherContext $ctx): mixed
    {
    ...
    public static function errors(MeteoprogWeatherContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
