...
// MeteoprogWeather SDK utility: fetcher

class MeteoprogWeatherFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MeteoprogWeatherSDK/1.0)';
    ...
    public static function call(MeteoprogWeatherContext $ctx, string $fullurl, array $fetchdef): array
    {
