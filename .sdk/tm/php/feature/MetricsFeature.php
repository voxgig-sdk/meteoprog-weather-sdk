...
// MeteoprogWeather SDK metrics feature
...
class MeteoprogWeatherMetricsFeature extends MeteoprogWeatherBaseFeature
{
    ...
    private function _record(MeteoprogWeatherContext $ctx, bool $ok): void
    {
