...
// MeteoprogWeather SDK timeout feature
...
class MeteoprogWeatherTimeoutFeature extends MeteoprogWeatherBaseFeature
{
    ...
    private function _with_timeout(MeteoprogWeatherContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MeteoprogWeatherContext $_ctx, float $ms): void
    {
        $client = $this->client;
