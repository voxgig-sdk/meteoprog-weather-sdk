...
// MeteoprogWeather SDK paging feature
...
class MeteoprogWeatherPagingFeature extends MeteoprogWeatherBaseFeature
{
    ...
    private function _is_list(MeteoprogWeatherContext $ctx): bool
    {
