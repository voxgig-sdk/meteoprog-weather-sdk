...
// MeteoprogWeather SDK ratelimit feature
...
class MeteoprogWeatherRatelimitFeature extends MeteoprogWeatherBaseFeature
{
    ...
    private function _acquire(MeteoprogWeatherContext $ctx): void
    {
    ...
    private function _track(MeteoprogWeatherContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
