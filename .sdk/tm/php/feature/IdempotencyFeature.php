...
// MeteoprogWeather SDK idempotency feature
...
class MeteoprogWeatherIdempotencyFeature extends MeteoprogWeatherBaseFeature
{
    ...
    private function _mutating(MeteoprogWeatherContext $ctx): bool
    {
