...
// MeteoprogWeather SDK telemetry feature
...
class MeteoprogWeatherTelemetryFeature extends MeteoprogWeatherBaseFeature
{
    ...
    private function _close(MeteoprogWeatherContext $ctx, bool $ok): void
    {
