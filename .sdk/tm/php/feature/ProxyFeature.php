...
// MeteoprogWeather SDK proxy feature
...
class MeteoprogWeatherProxyFeature extends MeteoprogWeatherBaseFeature
{
    ...
    public function init(MeteoprogWeatherContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MeteoprogWeatherContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
