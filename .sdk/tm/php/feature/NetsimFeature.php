...
// MeteoprogWeather SDK netsim feature
...
class MeteoprogWeatherNetsimFeature extends MeteoprogWeatherBaseFeature
{
    ...
    private function _simulate(MeteoprogWeatherContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MeteoprogWeatherContext $ctx, array $applied): void
    {
        $client = $this->client;
