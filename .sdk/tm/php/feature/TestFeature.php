...
// MeteoprogWeather SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MeteoprogWeatherTestFeature extends MeteoprogWeatherBaseFeature
{
    ...
    public function init(MeteoprogWeatherContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MeteoprogWeatherContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = MeteoprogWeatherParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MeteoprogWeatherContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MeteoprogWeatherContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = MeteoprogWeatherParam::call($ctx, $k);
