...
// MeteoprogWeather SDK streaming feature
...
class MeteoprogWeatherStreamingFeature extends MeteoprogWeatherBaseFeature
{
    ...
    private function _iterate(MeteoprogWeatherResult $result): \Generator
    {
    ...
    private function _streamable(MeteoprogWeatherContext $ctx): bool
    {
