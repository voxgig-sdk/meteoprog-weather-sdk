...
// MeteoprogWeather SDK rbac feature
...
class MeteoprogWeatherRbacFeature extends MeteoprogWeatherBaseFeature
{
    ...
    private function _required(MeteoprogWeatherContext $ctx): ?string
    {
    ...
    private function _reject(MeteoprogWeatherContext $ctx, string $required): void
    {
    ...
    private function _track(MeteoprogWeatherContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
