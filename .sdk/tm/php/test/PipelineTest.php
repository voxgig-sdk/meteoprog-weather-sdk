...
// MeteoprogWeather SDK pipeline test
//
...
{
    private static function utility(): MeteoprogWeatherUtility
    {
        return new MeteoprogWeatherUtility();
    }
    ...
    private static function ctx(array $over = []): MeteoprogWeatherContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MeteoprogWeatherContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MeteoprogWeatherOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MeteoprogWeatherError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MeteoprogWeatherOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MeteoprogWeatherMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MeteoprogWeatherOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MeteoprogWeatherMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MeteoprogWeatherOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MeteoprogWeatherMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MeteoprogWeatherSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MeteoprogWeatherMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MeteoprogWeatherResponse([]),
            'result' => new MeteoprogWeatherResult([]),
        ]);
        [, $err] = MeteoprogWeatherMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new MeteoprogWeatherSpec([]),
            'response' => null,
            'result' => new MeteoprogWeatherResult([]),
        ]);
        [, $err] = MeteoprogWeatherMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MeteoprogWeatherSpec(['step' => 's']),
            'response' => new MeteoprogWeatherResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MeteoprogWeatherResult([]),
        ]);
        [, $err] = MeteoprogWeatherMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MeteoprogWeatherSpec(['step' => 's']),
            'response' => new MeteoprogWeatherResponse(self::resp(200, ['v' => 1])),
            'result' => new MeteoprogWeatherResult([]),
        ]);
        [, $err] = MeteoprogWeatherMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MeteoprogWeatherSpec(['step' => 's']),
            'response' => new MeteoprogWeatherResponse(self::resp(200, ['v' => 2])),
            'result' => new MeteoprogWeatherResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MeteoprogWeatherMakeResponse::call($ctx);
    ...
    {
        $preset = new MeteoprogWeatherResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MeteoprogWeatherSpec([]),
            'response' => new MeteoprogWeatherResponse([]),
            'result' => new MeteoprogWeatherResult([]),
        ...
        [$got, $err] = MeteoprogWeatherMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MeteoprogWeatherResult([])]);
        [, $err] = MeteoprogWeatherMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MeteoprogWeatherSpec([]), 'result' => null]);
        [, $err] = MeteoprogWeatherMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MeteoprogWeatherSpec(['step' => 's']),
            'result' => new MeteoprogWeatherResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MeteoprogWeatherOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MeteoprogWeatherMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MeteoprogWeatherSpec(['step' => 's']),
            'result' => new MeteoprogWeatherResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MeteoprogWeatherOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MeteoprogWeatherMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MeteoprogWeatherResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MeteoprogWeatherSpec([]),
            'result' => new MeteoprogWeatherResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MeteoprogWeatherMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MeteoprogWeatherMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MeteoprogWeatherError('boom', 'boom');
        $utility->fetcher = function (MeteoprogWeatherContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MeteoprogWeatherSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MeteoprogWeatherMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MeteoprogWeatherContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MeteoprogWeatherMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MeteoprogWeatherResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        MeteoprogWeatherMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MeteoprogWeatherContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MeteoprogWeatherSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MeteoprogWeatherMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MeteoprogWeatherResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MeteoprogWeatherSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MeteoprogWeatherMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MeteoprogWeatherMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MeteoprogWeatherMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MeteoprogWeatherResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MeteoprogWeatherDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MeteoprogWeatherResult(['ok' => false])]);
        $this->expectException(MeteoprogWeatherError::class);
        MeteoprogWeatherDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MeteoprogWeatherResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MeteoprogWeatherMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        MeteoprogWeatherMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MeteoprogWeatherBaseFeature();
        $b = new MeteoprogWeatherBaseFeature();
        MeteoprogWeatherFeatureAdd::call($ctx, $a);
        MeteoprogWeatherFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MeteoprogWeatherBaseFeature
    {
        $f = new MeteoprogWeatherBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MeteoprogWeatherFeatureAdd::call($ctx, self::named_feature('a'));
        MeteoprogWeatherFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        MeteoprogWeatherFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        MeteoprogWeatherFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        MeteoprogWeatherFeatureAdd::call($ctx, $replace);
        ...
        MeteoprogWeatherFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): MeteoprogWeatherContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MeteoprogWeatherSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MeteoprogWeatherPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        MeteoprogWeatherPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MeteoprogWeatherResponse(['headers' => null]),
            'result' => new MeteoprogWeatherResult([]),
        ]);
        MeteoprogWeatherResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        MeteoprogWeatherResultBody::call($ctx);
