...
from projectname_sdk.core.control import MeteoprogWeatherControl
...
class MeteoprogWeatherContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = MeteoprogWeatherControl()
        ...
        if isinstance(sp, MeteoprogWeatherSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MeteoprogWeatherResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MeteoprogWeatherResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return MeteoprogWeatherOperation({})
    ...
    def make_error(self, code, msg):
        return MeteoprogWeatherError(code, msg, self)
