...
class MeteoprogWeatherTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MeteoprogWeatherTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = MeteoprogWeatherTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = MeteoprogWeatherTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
