...
from meteoprogweather_sdk.utility import register

# Load features
from meteoprogweather_sdk.feature.base_feature import MeteoprogWeatherBaseFeature
from meteoprogweather_sdk.features import _has_feature, _make_feature
...
class MeteoprogWeatherSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = MeteoprogWeatherUtility()
        self._utility = utility

        from meteoprogweather_sdk.config import shared_config
    ...
    def get_utility(self):
        return MeteoprogWeatherUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MeteoprogWeatherSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Current(self, data=None) -> "CurrentEntity":
        ...
        from meteoprogweather_sdk.entity.current_entity import CurrentEntity
    ...
    def Historical(self, data=None) -> "HistoricalEntity":
        ...
        from meteoprogweather_sdk.entity.historical_entity import HistoricalEntity
    ...
    def WeatherForecast(self, data=None) -> "WeatherForecastEntity":
        ...
        from meteoprogweather_sdk.entity.weather_forecast_entity import WeatherForecastEntity
        return WeatherForecastEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "MeteoprogWeatherSDK":
        if sdkopts is None:
            sdkopts = {}
