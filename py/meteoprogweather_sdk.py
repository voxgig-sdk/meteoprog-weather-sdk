...
from core.utility_type import MeteoprogWeatherUtility
...
class MeteoprogWeatherSDK:
    ...
    def current(self):
        ...
        from entity.current_entity import CurrentEntity
        cached = getattr(self, "_current", None)
        if cached is None:
            cached = CurrentEntity(self, None)
