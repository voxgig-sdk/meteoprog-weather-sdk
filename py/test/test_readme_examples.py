# MeteoprogWeather SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MeteoprogWeatherSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MeteoprogWeatherSDK(...) and MeteoprogWeatherSDK.test(...) become
#      MeteoprogWeatherSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "meteoprogweather_sdk"
_SDK_CLASS = "MeteoprogWeatherSDK"
