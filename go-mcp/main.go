// Command MeteoprogWeather-mcp is an MCP server exposing the MeteoprogWeather
// SDK as MCP tools.
//
// Two tools are registered:
//
//	MeteoprogWeather_list  — list records of an entity
//	MeteoprogWeather_load  — load a single record of an entity
//
