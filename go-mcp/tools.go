...
type Args struct {
	Entity string         `json:"entity" jsonschema:"current | historical | weather_forecast"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.MeteoprogWeatherSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "meteoprog-weather_list",
		Description: "List records from MeteoprogWeather. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "meteoprog-weather_load",
		Description: "Load a single record from MeteoprogWeather. " +
...
func runOp(client *sdk.MeteoprogWeatherSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MeteoprogWeatherSDK, name string) (sdk.MeteoprogWeatherEntity, error) {
