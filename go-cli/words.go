...
func registerSDKWords(r *eng.Registry, client *sdk.MeteoprogWeatherSDK) {
...
func runOp(client *sdk.MeteoprogWeatherSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
