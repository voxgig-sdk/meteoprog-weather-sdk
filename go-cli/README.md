...
AQL-driven CLI and REPL for the MeteoprogWeather SDK. Positional arguments are
...
```sh
go build -o meteoprog-weather-cli ./...
```
...
./meteoprog-weather-cli list current
./meteoprog-weather-cli load 1 current
./meteoprog-weather-cli load '{id:1}' current
