...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.METEOPROG_WEATHER_TEST_LIVE ||
    'TRUE' === process.env.METEOPROG_WEATHER_TEST_OVERRIDE
  ) {
  ...
  m.METEOPROG_WEATHER_TEST_EXPLAIN = process.env.METEOPROG_WEATHER_TEST_EXPLAIN || m.METEOPROG_WEATHER_TEST_EXPLAIN
