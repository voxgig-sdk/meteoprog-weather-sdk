...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.METEOPROGWEATHER_TEST_LIVE ||
    'TRUE' === process.env.METEOPROGWEATHER_TEST_OVERRIDE
  ) {
  ...
  m.METEOPROGWEATHER_TEST_EXPLAIN = process.env.METEOPROGWEATHER_TEST_EXPLAIN || m.METEOPROGWEATHER_TEST_EXPLAIN
