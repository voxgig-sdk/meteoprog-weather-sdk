...
describe('WeatherForecastDirect', async () => {
  ...
  test('direct-list-weather_forecast', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-weather_forecast', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['METEOPROG_WEATHER_TEST_WEATHER_FORECAST_ENTID']
