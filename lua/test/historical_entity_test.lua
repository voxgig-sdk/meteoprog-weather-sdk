...
describe("HistoricalEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set METEOPROG_WEATHER_TEST_HISTORICAL_ENTID JSON to run live")
      return
    end
...
function historical_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("METEOPROG_WEATHER_TEST_HISTORICAL_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["METEOPROG_WEATHER_TEST_HISTORICAL_ENTID"])
