...
describe("WeatherForecastDirect", function()
  it("should direct-list-weather_forecast", function()
    local setup = weather_forecast_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-weather_forecast", setup.live and "live" or "unit")
