...
describe("HistoricalDirect", function()
  it("should direct-list-historical", function()
    local setup = historical_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-historical", setup.live and "live" or "unit")
