...
describe("CurrentDirect", function()
  it("should direct-load-current", function()
    local setup = current_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-current", setup.live and "live" or "unit")
...
function current_direct_setup(mockres)
