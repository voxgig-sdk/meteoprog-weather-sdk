...
// MeteoprogWeather SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class MeteoprogWeatherTransformResponse
{
    public static function call(MeteoprogWeatherContext $ctx): mixed
    {
        ...
        $transform = MeteoprogWeatherHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
