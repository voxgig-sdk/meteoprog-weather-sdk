...
// MeteoprogWeather SDK Historical entity
...
class HistoricalEntity
{
    ...
    /**
     * List Historical items matching the given filter.
     *
     * @param HistoricalListMatch|array|null $reqmatch Match filter (any subset
     *   of Historical fields) as an assoc-array; HistoricalListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Historical[]|array A list of Historical items as assoc-arrays at
