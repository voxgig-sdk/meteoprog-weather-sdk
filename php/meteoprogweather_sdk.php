...
class MeteoprogWeatherSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = MeteoprogWeatherHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = MeteoprogWeatherHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!MeteoprogWeatherFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, MeteoprogWeatherFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return MeteoprogWeatherUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = MeteoprogWeatherHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = MeteoprogWeatherHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = MeteoprogWeatherHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new MeteoprogWeatherError($op . "_allow",
                "MeteoprogWeatherSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = MeteoprogWeatherHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new MeteoprogWeatherError("graphql_error",
                "MeteoprogWeatherSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new MeteoprogWeatherSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
