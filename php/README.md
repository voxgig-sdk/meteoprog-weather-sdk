...
The PHP SDK for the MeteoprogWeather API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Current(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->MeteoprogWeather(null)->load(
    ["id" => "test01"], null
);
