...
// MeteoprogWeather SDK clienttrack feature
...
class MeteoprogWeatherClienttrackFeature extends MeteoprogWeatherBaseFeature
{
    ...
    public function PostConstruct(MeteoprogWeatherContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'MeteoprogWeather-SDK';
