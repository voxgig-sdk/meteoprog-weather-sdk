...
// MeteoprogWeather SDK audit feature
...
class MeteoprogWeatherAuditFeature extends MeteoprogWeatherBaseFeature
{
    ...
    private function _emit(MeteoprogWeatherContext $ctx, string $outcome): void
    {
