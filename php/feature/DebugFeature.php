...
// MeteoprogWeather SDK debug feature
...
class MeteoprogWeatherDebugFeature extends MeteoprogWeatherBaseFeature
{
    ...
    private function _finish(MeteoprogWeatherContext $ctx, bool $ok): void
    {
