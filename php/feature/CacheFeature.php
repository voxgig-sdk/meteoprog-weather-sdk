...
// MeteoprogWeather SDK cache feature
...
class MeteoprogWeatherCacheFeature extends MeteoprogWeatherBaseFeature
{
    ...
    private function _through(MeteoprogWeatherContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
