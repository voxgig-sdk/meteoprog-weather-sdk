...
{
    public function test_direct_list_weather_forecast(): void
    {
        $setup = weather_forecast_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-weather_forecast", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
