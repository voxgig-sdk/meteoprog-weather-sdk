...
// MeteoprogWeather SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MeteoprogWeatherSDK::test)
...
{
    private const SDK_CLASS = 'MeteoprogWeatherSDK';
    ...
    private const SDK_BASE = 'meteoprogweather_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../meteoprogweather_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
