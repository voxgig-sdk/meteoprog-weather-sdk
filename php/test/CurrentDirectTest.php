...
class CurrentDirectTest extends TestCase
{
    public function test_direct_load_current(): void
    {
        $setup = current_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-current", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
