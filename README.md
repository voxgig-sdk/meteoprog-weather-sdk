...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/meteoprog-weather` | `npm install @voxgig-sdk/meteoprog-weather` |
| Python | `voxgig-sdk-meteoprog-weather` | `pip install voxgig-sdk-meteoprog-weather` |
| PHP | `voxgig-sdk/meteoprog-weather` | `composer require voxgig-sdk/meteoprog-weather` |
| Golang | `github.com/voxgig-sdk/meteoprog-weather-sdk/go` | `go get github.com/voxgig-sdk/meteoprog-weather-sdk/go` |
| Ruby | `voxgig-sdk-meteoprog-weather` | `gem install voxgig-sdk-meteoprog-weather` |
| Lua | `voxgig-sdk-meteoprog-weather` | `luarocks install voxgig-sdk-meteoprog-weather` |
