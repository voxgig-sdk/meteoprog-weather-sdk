...
#      offline in seeded test mode (MeteoprogWeatherSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "MeteoprogWeather_sdk.rb")
  SDK_CLASS = "MeteoprogWeatherSDK"
