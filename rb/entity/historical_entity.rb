...
class HistoricalEntity
  ...
  #
  # @param reqmatch [HistoricalListMatch, Hash, nil] match filter (any subset of
  #   Historical fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Historical>, Array] the matching Historical items; raises MeteoprogWeatherError on failure
