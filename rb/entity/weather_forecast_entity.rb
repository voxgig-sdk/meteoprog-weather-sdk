...
class WeatherForecastEntity
  ...
  #
  # @param reqmatch [WeatherForecastListMatch, Hash, nil] match filter (any subset of
  #   WeatherForecast fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<WeatherForecast>, Array] the matching WeatherForecast items; raises MeteoprogWeatherError on failure
